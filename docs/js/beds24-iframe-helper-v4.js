/*
 * TNH Beds24 Iframe Helper v4
 * Load via customhead: <script src="https://astrongpresence.com/beds24-iframe-helper-v4.js"></script>
 *
 * Three jobs:
...
(function(){
  ...
  if (isWidget && isEmbedded) {
    ...
    /* Periodic fallback — report every 1s for 30s to catch late AJAX renders */
