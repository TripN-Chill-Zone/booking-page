/*
 * TNH Beds24 Iframe Helper v2
 * Load via customhead: <script src="https://astrongpresence.com/beds24-iframe-helper-v2.js"></script>
 *
 * Three jobs:
...
(function(){
  ...
  function addStickyBarStyles() {
    ...
    stickyCSS.textContent = ''
      ...
      + '}'
      /* Per-room book button: initially subtle, activates on quantity selection */
      + '.multiplebookbutton{'
      +   'margin-top:8px;'
      + '}';
