/*
 * TNH Beds24 Iframe Helper v5
 * Load via customhead: <script src="https://astrongpresence.com/beds24-iframe-helper-v5.js"></script>
 *
 * Three jobs:
...
(function(){
  ...
  if (isWidget && isEmbedded) {
    ...
    function send() {
      /* Start with full scrollHeight */
      var h = document.documentElement.scrollHeight;

      /* Subtract hidden elements' heights to avoid empty gap */
      var hidden = [
