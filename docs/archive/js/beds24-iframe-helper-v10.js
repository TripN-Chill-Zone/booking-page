/*
 * TNH Beds24 Iframe Helper v10
 * Load via customhead: <script src="https://astrongpresence.com/beds24-iframe-helper-v10.js"></script>
 *
...
(function(){
   ...
   * Unhide the guest selector in its original position,
   * relabel from "Guests" to "Beds"
   * ============================================ */
  function fixDormRooms() {
    ...
    hiddenInputs.forEach(function(input) {
      ...
      /* Find and unhide the guest selector */
  ...
  /* ============================================
   * SECTION 4: Per-room Book buttons + bottom bar
   * ============================================ */
  function addStyles() {
    var css = document.createElement('style');
    css.textContent = ''
      /* Per-room Book button — prominent green */
      ...
      + '}'
      /* Bottom summary bar — clean styling, sits at content bottom */
    ...
    if (typeof MutationObserver !== 'undefined') {
      ...
      new MutationObserver(function() {
        ...
        fixTimer = setTimeout(function() {
          setFormTarget(); /* re-apply in case form was re-rendered */
          fixDormRooms();
        }, 300);
