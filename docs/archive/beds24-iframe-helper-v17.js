/*
 * TNH Beds24 Iframe Helper v17
 * Load via customhead: <script src="https://astrongpresence.com/beds24-iframe-helper-v17.js"></script>
 *
 * Session 10 updates:
 * - Viewport clamp: html/body max-width:100vw + overflow-x:hidden to prevent
 *   iOS Safari iframe expansion from Bootstrap container widths
 * - .container forced to max-width:100% inside iframe
 *
 * Session 9 updates:
