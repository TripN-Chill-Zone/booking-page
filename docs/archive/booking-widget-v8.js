/*
 * Trip'N'Hostel Booking Widget v7
 * Self-injecting — just add <div id="tnh-booking-root"></div> and load this script.
 * CONFIG is set per-property at the top.
 *
 * v7 changes:
 * - Checkout now stays in iframe (no breakout to full page)
 * - Handles tnh-page-change messages from helper (scroll to top, update UI)
 * - Summary bar updates for checkout/confirmation states
 * - Loading spinner shown briefly on page transitions
 */
(function() {
  var CONFIG = {
    ownerid: '141266',
    propid:  '271142',
    cssfile: 'https://astrongpresence.com/CSS-base-v4.css',
    minNights: 2,
    maxNights: 90,
    defaultNights: 2,
    primaryColor: '#E7A35C',
